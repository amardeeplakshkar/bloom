...
const Header = ({ toggleCodeView, codeView }: { toggleCodeView: () => void, codeView: boolean }) => {
    const [open, setOpen] = useState(false)
    const [value, setValue] = useState("")
    return (
        <header className='flex items-center gap-2 justify-between p-2'>
            <div className='flex items-center gap-1 group'>
                ...
                <Popover open={open} onOpenChange={setOpen}>
                    <PopoverTrigger asChild>
                        ...
                        >
                            <span className="truncate -ml-2.5">
                                Bloom
                            </span>
